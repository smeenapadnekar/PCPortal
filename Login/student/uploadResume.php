    ...
    <div class="main-panel">
       ...
       <div class="content">
           <div class="container-fluid">
                       ...
                       <form action="Upload.php" method="post" enctype="multipart/form-data"> 
                           ...
                           <div class="col-md-12">
                            ...
                            <tr> 
                                ...
                                <input name="userfile" type="file" accept="application/pdf" id="userfile"> 
                                </td>
               ...
               <div class="content">
               <form action="downloadcv.php">
                          <label>
                              Download Your Resume
                          </label>
                           <input type="submit" name="downloadcv" class="box" placeholder="Download CV" >
                       </form>
                </div>       
           </div>
       </div>
