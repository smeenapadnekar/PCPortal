                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                    ...
                                    <div class="row">
                                        <?php
                                           //include("displaynoti.php");
                                            //session_start();
                                            $user=$_SESSION['susername'];

                                            $query="SELECT * FROM event_list JOIN student WHERE  event_list.recipients_gpa<=student.Cgpa AND event_list.recipients_branch=student.Branch ORDER BY date ";
